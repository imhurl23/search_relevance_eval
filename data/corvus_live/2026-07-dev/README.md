...
- `edgar_item_502_candidates.jsonl`: metadata requiring source-specific curation.
...
director and officer events; each candidate must be curated to determine
...
Additional artifacts from this development pull:
...
curated, and the generous pairing window means a Form 3 can sit next to an
unrelated Item 5.02 — curation must resolve that ambiguity. Section 16
